...
if [ -d "$RYUDIR" ]; then
    ./bin/ryu-manager --observe-links ryu.app.sdnhub_apps.fileserver ryu.app.sdnhub_apps.host_tracker_rest  ryu.app.rest_topology ryu.app.ofctl_rest ryu.app.a_ids ryu/app/AdaptiveIDS/ids_main.py
